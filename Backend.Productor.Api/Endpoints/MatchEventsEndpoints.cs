...
public static class MatchEventsEndpoints
{
    public static void MapMatchEventsEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        {
            var matchId = (request.MatchId == null || request.MatchId == 0) ? Random.Shared.Next(1, 100000) : request.MatchId.Value;
        ...
        .WithSummary("Registrar inicio de partido") // <--- ESTO REEMPLAZA AL XML <summary>
        ...
        .WithDescription("Registra una sustituci�n de jugador y publica el evento SubstitutionEvent.");
    }
}