...
public class NotificationsConsumer : BackgroundService
{
    ...
    private const string QueueName = "queue.notifications";
        ...
        ILogger<NotificationsConsumer> logger)
    {
        ...
        _logger.LogInformation("NOTIFICATIONS-CONSUMER: Conectado a RabbitMQ.");
    }
    ...
    private async Task OnMessageReceived(object sender, BasicDeliverEventArgs ea)
    {
        ...
        try
        {
            using (var scope = _serviceProvider.CreateScope())
            {
                ...
                await notificationsService.HandleEventAsync(message);
            }
    ...
    {
        _logger.LogInformation("Cerrando consumidor de notificaciones...");
        _channel.Close();
        _connection.Close();
